...
programa : T_PROGRAM programa1
    | error T_DOT { yyerror("Erro sintatico: esperado 'program'"); yyclearin; }
    ;

programa1 : T_ID {} programa2 {}
    | error T_SEMICOLON { yyerror("Erro sintatico: esperado 'id'"); yyclearin;} corpo programa3
    | error T_DOT { yyerror("Erro sintatico: esperado 'program'"); yyclearin; }
    ;
...
programa3 : T_DOT {}
    | error { yyerror("Erro sintatico: esperado 'program'"); yyclearin; }
    ;
