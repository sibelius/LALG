...
{
       0,     0,     3,     5,    10,    15,    20,    25,    30,    32,
      35,    38,    41,    43,    47,    51,    55,    56,    60,    64,
      68,    70,    72,    74,    78,    82,    84,    86,    88
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    17,    -1,     5,    18,     6,    22,    -1,
       1,    18,     6,    22,    -1,     5,     1,     6,    22,    -1,
       5,    18,     1,    22,    -1,     5,    18,     6,     1,    -1,
       1,    -1,    20,    19,    -1,     1,    19,    -1,    20,     1,
      -1,     1,    -1,     8,    20,    19,    -1,     8,     1,    19,
      -1,     8,    20,     1,    -1,    -1,     9,     7,    21,    -1,
       9,     1,    21,    -1,     9,     7,     1,    -1,     1,    -1,
       3,    -1,     4,    -1,    22,    23,    22,    -1,    22,     1,
      22,    -1,     9,    -1,    10,    -1,    11,    -1,     1,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,   102,   102,   104,   105,   106,   107,   108,   109,   111,
     112,   113,   114,   116,   117,   118,   119,   122,   123,   128,
     133,   135,   136,   138,   157,   162,   177,   178,   179
};
#endif
...
{
  "$end", "error", "$undefined", "I_NUMBER", "R_NUMBER", "LET", "IN",
  "ATRIB", "VIRG", "IDENT", "ADI", "SUB", "MUL", "DIV", "L_ERRO",
  "$accept", "s", "comando_let", "dec_lista", "dec_lista2", "decl",
  "number", "exp", "op", 0
};
#endif
...
{
       0,     0,     0,     0,     2,    12,     0,     0,     0,    12,
       0,     1,     0,    10,     0,     0,     0,    11,     9,     0,
       0,     0,    16,     0,    21,    22,    18,    19,    17,    25,
       0,     0,     0,     7,     0,    14,    15,    13,     0,    26,
      27,     0,     0,     0
};
...
{
      56,     7,    40,     9,   -20,     5,    55,     6,    46,    38,
      57,   -20,    41,   -20,    28,    63,    36,   -20,   -20,    36,
      36,    42,    51,    47,   -20,   -20,   -20,   -20,   -20,   -20,
       4,    10,    23,   -20,    25,   -20,   -20,   -20,    36,   -20,
     -20,    36,    27,    29
};
...
{
      31,    32,    34,    18,    -4,    38,   -20,    -8,     5,    11,
      -5,    38,    16,    12,    39,    40,     6,    35,    37,    42,
      39,    40,    43,    -6,    38,    -3,    38,   -24,    38,   -23,
      38,    24,    25,    39,    40,    39,    40,    39,    40,    39,
      40,     9,    22,    33,    19,    29,    12,    17,    36,     6,
       6,    29,   -16,   -16,    12,    12,    14,     1,    20,    12,
      10,     2,    15,    21,    27,    23,    24,    25,     0,    28
};

static const yytype_int8 yycheck[] =
{
      19,    20,    21,     8,     0,     1,     1,     0,     1,     0,
       0,     1,     6,     8,    10,    11,     9,    22,    23,    38,
      10,    11,    41,     0,     1,     0,     1,     0,     1,     0,
       1,     3,     4,    10,    11,    10,    11,    10,    11,    10,
      11,     1,     1,     1,     6,     9,     8,     1,     1,     9,
       9,     9,     6,     6,     8,     8,     1,     1,     1,     8,
       2,     5,     7,     6,     1,    12,     3,     4,    -1,    15
};
...
{
       0,     1,     5,    16,    17,     1,     9,    18,    20,     1,
      18,     0,     8,    19,     1,     7,     6,     1,    19,     6,
       1,     6,     1,    20,     3,     4,    21,     1,    21,     9,
      22,    22,    22,     1,    22,    19,     1,    19,     1,    10,
      11,    23,    22,    22
};
...
/* Line 1455 of yacc.c  */
#line 105 "sample.y"
    { yyerrok; printf("Erro sintatico: Era esperado o comando 'let', encontrado %d\n", yychar); }
    break;
...
/* Line 1455 of yacc.c  */
#line 107 "sample.y"
    { yyerrok; printf("Erro sintatico: Era esperado o comando 'in', encontrado %d\n", yychar); }
    break;
...
/* Line 1455 of yacc.c  */
#line 108 "sample.y"
    { yyerrok; printf("Erro sintatico: Era esperado uma expressoa apos IN, encontrado %d\n", yychar); }
    break;
...
/* Line 1455 of yacc.c  */
#line 122 "sample.y"
    { addInTable( (yyvsp[(1) - (3)].name), (yyvsp[(3) - (3)].snode).type, (yyvsp[(3) - (3)].snode).i_value, (yyvsp[(3) - (3)].snode).f_value ); }
    break;
...
#line 128 "sample.y"
    {
			...
			yyerrok;
			addInTable( (yyvsp[(1) - (3)].name), INDEFINED, 0, 0 );
		}
    break;
...
#line 138 "sample.y"
    {
			...
			if( (yyvsp[(1) - (3)].snode).type == INDEFINED || (yyvsp[(3) - (3)].snode).type == INDEFINED ){
				...
				if( (yyvsp[(1) - (3)].snode).type != (yyvsp[(3) - (3)].snode).type ){
					(yyval.snode).type = INDEFINED;
					printf("Erro semantico: Operação sobre valores de tipos diferentes\n");
					code_generate = FALSE;
				}else{
					(yyval.snode).type = (yyvsp[(1) - (3)].snode).type;
					
					buidOperator( (yyvsp[(2) - (3)].math_op) );
				}
			}
		}
    break;
